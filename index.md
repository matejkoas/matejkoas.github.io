...
<div class="hero-section">
  ...
  <h2>Hi, I'm Aleksandr Mateiko.</h2>

  <p>
    I design and build data workflows that transform fragmented business data
    into reliable analytical systems.
  </p>

  <p>
    My expertise includes ETL development, API integrations, business intelligence,
    reporting automation and data pipeline engineering.
  </p>
...
<!-- Начало секции с предыдущими проектами -->
<section class="projects-section">

  <h2>Previous Analytics Projects</h2>

  <p class="section-description">
      Earlier analytical projects focused on statistical analysis,
      experimentation and business-oriented insights.
  </p>
  <div class="case-grid">
...
<!-- Конец секции с предыдущими проектами -->


<!-- Начало секции с дополнительными проектами -->
<section class="projects-section">

  <h2>Side Projects</h2>

  <p class="section-description">
      Personal projects driven by curiosity and interest in applying
      analytical thinking to unconventional questions.
  </p>

<!-- Кейс про нумерологию -->
  <div class="case-card">
